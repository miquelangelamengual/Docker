  ...
  <q-page class="flex column" padding>
    <div>
      <q-btn-group push class="q-mb-lg q-mr-lg">
        <q-btn  color="primary" label="Nova categoria" icon="add" :to="'/apps/convalidacions/categoria'"/>
      </q-btn-group>
    ...
    >
      ...
      <template v-slot:body-cell-accions="props">
        <q-td :props="props">
          <div>
            <q-btn-group push>
              <q-btn icon="edit" color="primary" dense :to="'/apps/convalidacions/categoria/'+props.value">
                <q-tooltip>
                  Edita
                </q-tooltip>
              </q-btn>
